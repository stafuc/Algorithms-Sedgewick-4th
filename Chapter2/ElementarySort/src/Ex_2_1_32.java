...
public class Ex_2_1_32 {
	...
	public static void main(String[] args) {
		...
		for (int N = min; N <= max; N += step) {
			...
			double time1 = SortCompare.timeRandamInput("QuickInsertion", N, t);
			StdDraw.point(N, time1 / t);
			
			StdDraw.setPenColor(StdDraw.GRAY);
			double time2 = SortCompare.timeRandamInput("Selection", N, t);
			StdDraw.point(N, time2 / t);
			
			StdDraw.setPenColor(StdDraw.RED);
			double time3 = SortCompare.timeRandamInput("Shell", N, t);
