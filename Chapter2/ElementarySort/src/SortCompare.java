...
public class SortCompare {
	...
	public static void main(String[] args) {
		...
		for (int N = 128; N < 1e5; N += N) {
			double time1 = timeRandamInput("Insertion", N, 5);
			double time2 = timeRandamInput("Selection", N, 5);
			double time3 = timeRandamInput("Shell", N, 5);
			double time4 = timeRandamInput("GuardInsertion", N, 5);
			double time5 = timeRandamInput("QuickInsertion", N, 5);
//			StdOut.printf("N:%5d, time ratio %.3f\n", N, time1 / time2);
			StdOut.printf("N:%3d, ins:%.3f, sel:%.3f, shell:%.3f, gIns:%.3f, qIns:%.3f\n", N, time1, time2, time3, time4, time5);
		}
	}
